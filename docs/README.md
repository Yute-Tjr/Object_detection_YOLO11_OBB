...
当前网页启动方式、部署模型和项目结构见项目根目录的 [README](../README.md)。本目录保存详细架构、生产部署、训练日志和历史实验背景，避免模型消融记录与日常使用说明混在同一份文档中。
...
- [2026-09-21 模型选型与网页状态快照](archive/06_model_selection_and_web_snapshot_20260921.md)

完整保留 YOLO11l/YOLO26、RHINO、Oriented R-CNN 的统一评测、batch 消融、分类别指标，以及端子检测网页完成一键启动前后的运行说明。
