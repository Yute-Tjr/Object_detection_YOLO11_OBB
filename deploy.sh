...
DEFAULT_DEBIAN_MIRROR_URL=${DEBIAN_MIRROR_URL:-}
DEFAULT_DEBIAN_SECURITY_MIRROR_URL=${DEBIAN_SECURITY_MIRROR_URL:-}
...
reset_default_image_source() {
    ...
    DEBIAN_MIRROR_URL=$DEFAULT_DEBIAN_MIRROR_URL
    DEBIAN_SECURITY_MIRROR_URL=$DEFAULT_DEBIAN_SECURITY_MIRROR_URL
    export PYTHON_BASE_IMAGE NODE_BASE_IMAGE NGINX_BASE_IMAGE POSTGRES_BASE_IMAGE
    export DEBIAN_MIRROR_URL DEBIAN_SECURITY_MIRROR_URL
    DOMESTIC_MIRROR_ACTIVE=false
}
...
enable_domestic_image_source() {
    ...
    DEBIAN_MIRROR_URL=${DOCKER_DEBIAN_MIRROR_URL:-https://mirrors.aliyun.com/debian}
    DEBIAN_SECURITY_MIRROR_URL=${DOCKER_DEBIAN_SECURITY_MIRROR_URL:-https://mirrors.aliyun.com/debian-security}
    export PYTHON_BASE_IMAGE NODE_BASE_IMAGE NGINX_BASE_IMAGE POSTGRES_BASE_IMAGE
    export DEBIAN_MIRROR_URL DEBIAN_SECURITY_MIRROR_URL
